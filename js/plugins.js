...
!function (a, b, c, d) {
	...
	a.extend(e.prototype, {
		storeData: function (b, c) {
			...
			var a = this, b = a.filterConcat(a.defaultFilter);
			...
			var b, c = this, f = c.freeSpaces.slice(-1)[0].topStart - c.options.gapHorizontal;
	...
	b.prototype.registerFilter = function () {
		...
		b.wrap = b.filters.find(".cbp-l-filters-dropdownWrap").on({
			...
			var g = a(f), h = "*", i = g.find(".cbp-filter-item");
	...
	d.Public = {
		init: function (a, b) {
			...
			var e = d.Private.checkInstance.call(this, "appendItems"), f = a(b).filter(".cbp-item");
	...
	for (var a = 0, b = ["moz", "webkit"],
			     c = 0; c < b.length && !window.requestAnimationFrame; ++c)window.requestAnimationFrame = window[b[c] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[b[c] + "CancelAnimationFrame"] || window[b[c] + "CancelRequestAnimationFrame"];
...
!function (i, t, o, s) {
	...
	e.prototype = {
		init: function () {
			...
			var i = this, o = t.pageYOffset, s = this.scaleObject(this.options.$video, i.options.$videoWrap),
					e = s.xPos, n = s.yPos;
			...
			for (var i = 0, o = ["ms", "moz", "webkit", "o"],
					     s = 0; s < o.length && !t.requestAnimationFrame; ++s)t.requestAnimationFrame = t[o[s] + "RequestAnimationFrame"], t.cancelAnimationFrame = t[o[s] + "CancelAnimationFrame"] || t[o[s] + "CancelRequestAnimationFrame"];
			t.requestAnimationFrame || (t.requestAnimationFrame = function (o) {
				var s = (new Date).getTime(), e = Math.max(0, 16 - (s - i)), n = t.setTimeout(function () {
					o(s + e)
				}, e);
				return i = s + e, n
...
(function (e, t) {
	...
	var rt = function (e) {
		var t = e.parent().find(".tp-bullets.tp-thumbs .tp-mask .tp-thumbcontainer"), n = t.parent(), r = n.offset(),
				...
				i = n.find(".bullet:first").outerWidth(true), u = i * e.find(">ul:first >li").length, a = u - o,
				f = a / o, l = 0 - s;
		if (l > 0) l = 0;
		if (l < 0 - u + o) l = 0 - u + o;
		if (!n.hasClass("over")) {
